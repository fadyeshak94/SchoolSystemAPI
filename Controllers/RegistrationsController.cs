...
public class RegistrationsController : ControllerBase
{
    ...
    public async Task<IActionResult> RequestRegistration([FromBody] RegistrationRequestDto dto)
    {
        ...
        {
            var existingPending = await _uow.PendingRegistrations.FindAsync(p => p.StudentId == dto.Id.Value && p.Status == "Pending");
    ...
    {
        var pendingList = await _uow.PendingRegistrations.FindAsync(p => p.Status == "Pending");
